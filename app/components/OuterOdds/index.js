      ...
      <div className="col-span-6 grid grid-cols-6">
        <div className="col-span-2 grid grid-cols-2 md:h-full cursor-pointer">
          {data?.runners?.[0]?.backPrice1 ? (
            <button
              className="bg-[#73bcf0] px-4 md:py-2 h-fit md:h-auto text-center text-14 font-semibold  text-black"
              onClick={() => {
                if (isLogin) {
                  addToBetPlace(
          ...
          {data?.runners?.[0]?.layPrice1 ? (
            <button
              className="bg-[#faaabb] px-4 md:py-2 h-fit md:h-auto text-center text-14 font-semibold  text-black"
              onClick={() => {
                isLogin
                  ? addToBetPlace(
                      data?.competition_name,
